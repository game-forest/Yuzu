...
namespace Yuzu.CloneUtil
{
	...
	{
		public static T MakeDelegate<T>(MethodInfo m)
			where T : Delegate
		{
		...
		public static T[] CloneArrayPrimitive<T>(object src) => src == null ? null : (T[])((Array)src).Clone();

		public static Array CloneArrayPrimitiveNDim(object src) => src == null ? null : (Array)((Array)src).Clone();
